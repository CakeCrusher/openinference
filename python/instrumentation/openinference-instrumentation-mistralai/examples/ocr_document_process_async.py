...
async def process_ocr():
    client = MistralAsyncClient(api_key="your-api-key-here")
    async with using_attributes(
        session_id="my-async-ocr-session",
        user_id="my-async-ocr-user",
        metadata={
            "document_type": "pdf",
            "test-int": 1,
            "test-str": "string",
        },
        tags=["ocr", "async", "document-processing"],
    ):
